    ...
    <main>
      <section className="mainPanel">
        <div className="panel-Description">
          ...
          <p>The code below will disappear as soon as you start typing! If you wish to see the code again click
            the 'Reset' button below the text editor. If you accurately write out the code without any errors, you can
            click 'Next Exercise'. If however, the code is too difficult for you to practise with, you can 'Skip' to the next!
            </p>
